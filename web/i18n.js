...
Object.assign(I18N_EN, {
  ...
  "Nettoyer ma bibliothèque": "Clean up my library",
  "Analyser ma bibliothèque": "Analyse my library",
  "Analyse ta collection et corrige ce qui manque : genre, sous-genre, année": "Scans your collection and fixes what's missing: genre, sub-genre, year",
  "Analyse de la collection…": "Analysing the collection…",
  "Recherche en ligne…": "Searching online…",
  "Recherche en ligne": "Searching online",
  "années écrites ·": "years written ·",
  "genres proposés": "genres suggested",
  "Arrêter": "Stop",
  "✓ Proposé par": "✓ Suggested by",
  "vos validations": "your validations",
  "🎉 Rien à corriger — ta bibliothèque est propre.": "🎉 Nothing to fix — your library is clean.",
  "complets ·": "complete ·",
  "à corriger": "to fix",
  ...
  "✓ Entrées de répertoire saines": "✓ Directory entries are sound",
  "entrée illisible": "unreadable entry",
  "lien brisé": "broken link",
  "Clique pour ouvrir le dossier.": "Click to open the folder.",
  "Genre…": "Genre…",
  ...
  "SOUS-GENRE TECHNO": "TECHNO SUB-GENRE",
  ...
  "Fichier de file trouvé mais illisible —": "Queue file found but unreadable —",
  "Aucune file détectée. Dépose le fichier DJHELPER_REVIEW.json à la racine de ta clé :": "No queue detected. Drop the DJHELPER_REVIEW.json file at the root of your USB stick:",
  "Configure d'abord la racine de ta clé USB sur l'accueil, puis dépose DJHELPER_REVIEW.json à sa racine.": "First set your USB stick root on the home screen, then drop DJHELPER_REVIEW.json at its root.",
  ...
  "Déduction depuis le nom · identification par empreinte audio · renommage des fichiers": "Inference from file names · audio-fingerprint identification · file renaming",
  "Identifier les fichiers inconnus (empreinte audio)": "Identify unknown files (audio fingerprint)",
  "Tout (": "All (",
  "proposé :": "suggested:",
  "année": "year",
