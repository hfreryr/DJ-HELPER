...
Object.assign(I18N_EN, {
  ...
  "Playlist « À CLASSER » ": "Playlist “À CLASSER” ",
  "régénérée": "regenerated",
  "créée": "created",
  " morceau(x)": " track(s)",
  " ignoré(s) — absents de la collection Traktor (importe d'abord TRACK BASE dans Traktor)": " skipped — not in the Traktor collection (import TRACK BASE into Traktor first)",
  "sauvegarde : ": "backup: ",
  "ouvre Traktor et glisse-dépose vers tes playlists.": "open Traktor and drag-and-drop into your playlists.",
  "Écrit dans": "Writes into",
  "une playlist « À CLASSER » contenant tes morceaux hors playlist (sauvegarde du .nml faite avant). Ouvre ensuite Traktor : glisse-dépose chaque morceau vers sa vraie playlist. La playlist est régénérée à chaque passage — les morceaux classés en disparaissent d'eux-mêmes. Traktor doit être fermé.": "an “À CLASSER” playlist with your unfiled tracks (the .nml is backed up first). Then open Traktor and drag each track to its real playlist. The playlist is regenerated on every pass — filed tracks drop out on their own. Traktor must be closed.",
...
Object.assign(I18N_EN, {
  ...
  // --- file de validation ---
  "File de validation": "Review queue",
  "Écoute et corrige en un clic les morceaux au classement incertain": "Listen and fix uncertain classifications in one click",
  "Aucune validation en attente. La file apparaîtra ici après un enrichissement.": "Nothing to review. The queue will appear here after an enrichment run.",
  "🎉 File terminée — tout est validé.": "🎉 Queue finished — everything is reviewed.",
  "Chargement de la file…": "Loading the queue…",
  "Valider tel quel": "Confirm as is",
  "Passer": "Skip",
  "Voir le fichier": "Show file",
  "Autre genre…": "Other genre…",
  "Année": "Year",
  "⚠ Fichier introuvable — branche ta clé USB ou vérifie la racine dans la configuration.": "⚠ File not found — plug in your USB stick or check the root folder in settings.",
  "Raccourcis :": "Shortcuts:",
  "lecture": "play/pause",
  "choix": "pick",
  "valider": "confirm",
  "passer": "skip",
  "Outils avancés (déduction, AcoustID, renommage)": "Advanced tools (inference, AcoustID, renaming)",
  "Tout (": "All (",
  "proposé :": "suggested:",
  "année": "year",
  "Écriture impossible :": "Could not write:",
  "Les morceaux dont le classement (genre, sous-genre, année) est incertain arrivent ici. Écoute l'extrait puis corrige en un clic — chaque validation est écrite dans": "Tracks whose classification (genre, sub-genre, year) is uncertain land here. Listen, then fix in one click — every validation is written into",
  "(sauvegarde automatique avant la première écriture du jour) et mémorisée pour classer automatiquement les prochains morceaux du même artiste.": "(automatic backup before the first write of the day) and memorised to auto-classify future tracks by the same artist.",
  "Ferme Traktor avant de valider": "Close Traktor before reviewing",
  ": il écrase le fichier à sa fermeture.": ": it overwrites the file when it quits.",
